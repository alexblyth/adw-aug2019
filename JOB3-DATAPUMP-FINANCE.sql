...
begin
    ...
    dbms_datapump.add_file(handle => h1, filename => 'https://objectstorage.us-ashburn-1.oraclecloud.com/n/idzo73zlod7f/b/DATA-PUMP/o/Finance.dmp', directory => 'OBJ_STORE_CRED', filetype => 5); 
