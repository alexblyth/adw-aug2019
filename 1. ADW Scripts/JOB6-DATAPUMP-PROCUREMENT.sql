...
set serveroutput on
set escape off
REM ERPDEMO03 tables 9

drop table ADMIN."IMP_PROCUREMENT_DMP-1";
...
begin
    h1 := dbms_datapump.open (operation => 'IMPORT', job_mode => 'FULL', job_name => 'IMP_PROCUREMENT_DMP-1', version => 'COMPATIBLE'); 
    tryGetStatus := 1;
    ...
    dbms_datapump.add_file(handle => h1, filename => 'https://objectstorage.ap-sydney-1.oraclecloud.com/n/sde0oema7qtx/b/DATA-PUMP/o/Procurement.dmp', directory => 'OBJ_STORE_CRED', filetype => 5); 
